...
d3.json(queryUrl, function(response) {
  ...
  for (var i = 0; i < response.features.length; i++) {
    ...
    // set up markers on map: size is proportional to earthquake magnitude
  ...
  // function to set up legend colors based on earthquake magnitude
  function getColor(d) {
    return d > 5 ? "red" :
           d > 4 ? "orangered" :
           d > 3 ? "orange" :
